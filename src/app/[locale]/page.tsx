    ...
    <div className={styles.container}>
      ...
      <section className={styles.mapSection}>
        <div className={styles.mapContainer}>
          <iframe 
            src="https://maps.google.com/maps?q=G%C3%BCne%C5%9Ftepe%20Mah.%20U%C4%9Fur%20Sk.%20No:16/A%20G%C3%BCng%C3%B6ren%20%C4%B0stanbul&t=&z=15&ie=UTF8&iwloc=&output=embed"
            width="100%" 
            height="450" 
            style={{ border: 0 }} 
          ...
          <div className={styles.mapOverlay}>
            <a 
              href="https://www.google.com/maps/dir//G%C3%BCne%C5%9Ftepe+Mah.+U%C4%9Fur+Sk.+No:16/A+G%C3%BCng%C3%B6ren+%C4%B0stanbul"
              target="_blank" 
              rel="noopener noreferrer"
              className="btn btn-primary"
            >
              {locale === 'tr' ? 'NASIL GİDERİM' : 'GET DIRECTIONS'}
            </a>
          </div>
        </div>
      </section>
